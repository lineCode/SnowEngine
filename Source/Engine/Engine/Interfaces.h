...
using StrongActorPtr = shared_ptr<Actor> ;
using WeakActorPtr = weak_ptr<Actor>;
using StrongActorComponentPtr = shared_ptr<ActorComponent> ;
using WeakActorComponentPtr = weak_ptr<ActorComponent> ;
...
using ScreenElementList = std::list<shared_ptr<IScreenElement> > ;
using GameViewList = std::list<shared_ptr<IGameView> > ;

////////////////////////////////////////////////////
//
// IKeyboardHandler Description		
// IPointerHandler Description		
// IJoystickHandler Description		
// IGamepadHandler Description		
//
...
using Lights = std::list<shared_ptr<LightNode> > ;
