#pragma once
//Engine Core Defination
//Last Modified On 19/12/15
...
public:
	...
	void AddRenderToScreenText(const std::string& str, float time, const D3DXCOLOR color= D3DXCOLOR(1.0f,1.0f,1.0f,1.0f));
...
private:
	...
	static void RenderTextStringToScreen(float fElapsedTime);
	std::vector<std::tuple<std::string,float,D3DXCOLOR>> m_ToRenderText;
};
