#pragma once
// SceneNodes.h - defines the base class for the 3D graphics scene graph, and derived classes like RootNode, Alpha scene nodes, Camera, Grids, etc.                  

#include "../Graphics3D/Geometry.h"
#include "../Graphics3D/Material.h"
#include "../Graphics3D/Shaders.h"
...
public:
	...
	SceneOctreeNode* GetContainer() const{ return m_Container; }
	void SetContainetr(SceneOctreeNode* _node) { m_Container = _node; }
};
...
using AlphaSceneNodeList = std::list<AlphaSceneNode *> ;
...
using SceneActorMap = std::map<ActorId, shared_ptr<ISceneNode> > ;
