// SceneNodes.cpp - defines the base class for the 3D graphics scene graph, and derived classes like RootNode, Alpha scene nodes, Camera, Grids, etc.                  
...
//
// D3DGrid9::VOnRestore						- 3rd Edition, 
