...
D3DRenderer11::D3DRenderer11() {
	...
	ID3D11Resource* DepthStencilRes;
	DXUTGetD3D11DepthStencilView()->GetResource(&DepthStencilRes);

	D3D11_SHADER_RESOURCE_VIEW_DESC srvDesc;
	srvDesc.Format = DXGI_FORMAT_R24_UNORM_X8_TYPELESS;

	if (devSettings.d3d11.sd.SampleDesc.Count > 1)
	...
	D3DRenderer::g_DialogResourceManager.GetD3D11Device()->CreateShaderResourceView(DepthStencilRes, &srvDesc, &m_DepthMapSRV);
...
//abstracts some of the calls to get the game engine to run under DX11.
