...
#pragma comment(lib, "Effects11d.lib")			// [mrmike] Note you can remove this if you don't want the D3DX11CreateEffectFromMemory API.
#include "d3dx11effect.h"

//
// VertexShader_HLSL::VertexShader_HLSL			- 
//
VertexShader_HLSL::VertexShader_HLSL()
{
...
//
// VertexShader_HLSL::OnRestore					- 
//
HRESULT VertexShader_HLSL::OnRestore(Scene *pScene)
{
	HRESULT hr = S_OK;
...
//
// VertexShader_HLSL::SetupRender					- 
//
HRESULT VertexShader_HLSL::SetupRender(Scene *pScene, SceneNode *pNode)
{
	HRESULT hr = S_OK;
...
//
// PixelShader_HLSL::PixelShader_HLSL	- 
//
PixelShader_HLSL::PixelShader_HLSL()
{
	m_pPixelShader = NULL;
...
//
// PixelShader_HLSL::OnRestore				- 
//
HRESULT PixelShader_HLSL::OnRestore(Scene *pScene)
{
	HRESULT hr = S_OK;
...
//
// PixelShader_HLSL::SetupRender				- 
//
HRESULT PixelShader_HLSL::SetupRender(Scene *pScene, SceneNode *pNode)
{
	HRESULT hr = S_OK;
...
//
// PixelShader_HLSL::SetTexture				- 
//
HRESULT PixelShader_HLSL::SetTexture(const std::string& textureName)
{
...
HRESULT PixelShader_HLSL::SetTexture(ID3D11ShaderResourceView* const *pDiffuseRV, ID3D11SamplerState * const *ppSamplers)
{
...
//               int the PixelShader_HLSL - this could be factored into a single component.  
