...
public:
	...
	virtual IEventDataPtr VCopy() const
	{
		return IEventDataPtr (GCC_NEW EvtData_Decompress_Request ( m_zipFileName, fileName ) );
	}
...
public:
	...
	virtual IEventDataPtr VCopy() const
	{
		return IEventDataPtr (GCC_NEW EvtData_Decompression_Progress ( m_progress, m_zipFileName, fileName, m_buffer ) );
	}
